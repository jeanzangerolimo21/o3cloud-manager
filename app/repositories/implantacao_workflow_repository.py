    ...
    def rastreabilidade_por_proposta(cls, proposta_id):
        return cls.fetch_one(
            ...
            SELECT
                ...
                prop.clicksign_status AS proposta_clicksign_status,
                prop.clicksign_document_key AS proposta_clicksign_document_key,
                prop.clicksign_envelope_id AS proposta_clicksign_envelope_id,
                prop.clicksign_sent_at AS proposta_clicksign_sent_at,
                prop.clicksign_signed_at AS proposta_clicksign_signed_at,
                prop.clicksign_completed_at AS proposta_clicksign_completed_at,
                c.id AS contrato_id,
                c.numero AS contrato_numero,
                ...
                c.clicksign_status AS contrato_clicksign_status,
                c.clicksign_document_key AS contrato_clicksign_document_key,
                c.clicksign_envelope_id AS contrato_clicksign_envelope_id,
                c.clicksign_enviado_em AS contrato_clicksign_enviado_em,
                c.clicksign_assinado_em AS contrato_clicksign_assinado_em,

    ...
    def _normalizar_rastreabilidade(row):
        ...
        return {
            "proposta": {
                ...
                "clicksign_status": row.get("proposta_clicksign_status"),
                "clicksign_document_key": row.get("proposta_clicksign_document_key"),
                "clicksign_envelope_id": row.get("proposta_clicksign_envelope_id"),
                "clicksign_sent_at": row.get("proposta_clicksign_sent_at"),
                "clicksign_signed_at": row.get("proposta_clicksign_signed_at"),
                "clicksign_completed_at": row.get("proposta_clicksign_completed_at"),
            ...
            "contrato": {
                ...
                "clicksign_status": row.get("contrato_clicksign_status"),
                "clicksign_document_key": row.get("contrato_clicksign_document_key"),
                "clicksign_envelope_id": row.get("contrato_clicksign_envelope_id"),
                "clicksign_enviado_em": row.get("contrato_clicksign_enviado_em"),
                "clicksign_assinado_em": row.get("contrato_clicksign_assinado_em"),
